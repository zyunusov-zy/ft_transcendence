...
class UserProfile(models.Model):
    ...
    email_2fa_code_expiry = models.DateTimeField(blank=True, null=True)
    ...
    def verify_2fa_code(self, code):
        if self.email_2fa_code == code and self.email_2fa_code_expiry and self.email_2fa_code_expiry > timezone.now():
            return True
        return False
